# 🔊 Yanich DeskSound `v1.0.13`

[![Release](https://img.shields.io/badge/Release-v1.0.13-00E5FF.svg?style=for-the-badge&logo=github)](https://github.com/vathsathya/yanich-desksound/releases/tag/v1.0.13)
...
- **Native Title Bar Integration:** Displays version string directly in the native Windows Title Bar (`Yanich DeskSound Server v1.0.13`).
...
| :--- | :--- | :--- | :--- |
| 🖥️ **Windows Server GUI** | [`yanich-desksound_v1.0.13.exe`](https://github.com/vathsathya/yanich-desksound/releases/download/v1.0.13/yanich-desksound_v1.0.13.exe) | **322 KB** | Portable Standalone Executable *(No install required!)* |
| 📱 **Android Receiver App** | [`yanich-desksound_v1.0.13.apk`](https://github.com/vathsathya/yanich-desksound/releases/download/v1.0.13/yanich-desksound_v1.0.13.apk) | **4.88 MB** | Release APK for Android 7.0 (API 24) or newer |
