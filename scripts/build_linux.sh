...
tar -czvf "yanich-desksound_v${VERSION}-linux-x64.tar.gz" "yanich-desksound_v${VERSION}-linux-x64"
echo "[+] Created tarball: yanich-desksound_v${VERSION}-linux-x64.tar.gz"
